...
contract MyERC721Enumerable is ERC165, ERC721, IERC721Enumerable {
   ...
   */
    function getTokenIds(address _tokenOwner) public view returns (uint256[]) {
        return _ownedTokens[_tokenOwner];
    }
